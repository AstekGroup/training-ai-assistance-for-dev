# MODULE 1 : Fondements Accélérés + Concepts Avancés

**Durée** : 1 journée (7h)  
**Objectifs** : Maîtriser les concepts avancés du Vibe Coding, le Prompt Engineering entreprise et préparer la transition vers les agents IA
...
- Comprendre les workflows Git collaboratifs avec IA
- Appliquer les bonnes pratiques (sécurité OWASP, performance, Clean Architecture)
...
**Prochaine étape** : Jour 2 - Agents IA et Développement Agentique
